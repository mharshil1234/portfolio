...
const ClubCard: React.FC<ClubCardProps> = ({
  ...
  return (
    <div className="bg-gray-800 p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center hover:scale-105 hover:-translate-y-2">
